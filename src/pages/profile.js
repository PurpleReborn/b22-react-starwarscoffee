...
class Profile extends Component {
    ...
    <div className="bg-profile ">
        <div className="text-white text-4xl font-medium pt-14 pb-12 pl-32"> User Profil</div>
        <div className="flex flex-row space-x-6 justify-center ">
            <div className="flex flex-col">
            <div className="flex flex-col bg-white box-profile-1 rounded-t-xl text-center space-y-6 ">
                ...
                <div className="text-lg pt-3 text-black" >{this.state.email}</div>
                </div>

                <div >Has been ordered - products</div>
            </div>
            <div className="bg-yellow-900 profile-1-2 rounded-b-xl"></div>
            </div>
            ...
            <div className="bg-yellow-900 profile-1-3 rounded-b-xl"></div>
            </div>
        </div>

        <div className="flex flex-row justify-center mt-24 space-x-20">
            <div className="flex flex-col">

            <div className="bg-white box-profile-3 rounded-t-xl">
            ...
            <div className="bg-yellow-900 profile-2-1 rounded-b-xl"></div>
            </div>
            ...
            <div className="flex flex-col ">
                ...
                <div className="flex flex-col space-y-8">
                    ...
                    <button onClick={this.changeUser} className="text-xl w-72 h-14 font-bold bg-yellow-900 text-white hover:bg-yellow-700 font-bold rounded-2xl ">
                        Save Change
                    </button>
                    <button className="text-xl w-72 h-14 font-bold bg-yellow-400 text-yellow-900 hover:bg-yellow-200 font-bold rounded-2xl ">
                        Cancel
                    </button>
                    </div>

                    <div className="flex flex-col space-y-6">                       
                        <button className="text-xl w-72 h-14 font-bold bg-white text-yellow-900 hover:bg-gray-300 font-bold rounded-2xl flex flex-row  space-x-36 justify-center ">
                            <div className="mt-auto mb-auto mr-2">Log out </div>
                            
                            
                        </button>
                    <button className="text-xl w-72 h-14 font-bold bg-white text-yellow-900 hover:bg-gray-300 font-bold rounded-2xl flex flex-row  space-x-24 justify-center ">
