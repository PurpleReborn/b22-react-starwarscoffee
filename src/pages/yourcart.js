...
class Payments extends Component {
  ...
  height: 199px;
            ...
            <div className ="pt-12">
                <button  type="button" disabled={this.state.button} onClick={() => this.createTransaction()} className ="w-44 md:w-96 h-20 bg-yellow-900 text-white font-bold text-base md:text-xl text-center hover:bg-yellow-700 rounded-3xl ">Confirm and Pay
            </button></div>
