    ...
    render() {
        ...
        <section className="w-full bg-no-repeat satu bg">
                    ...
                    <div className="flex-2">
                        ...
                        <div id="start2" className="text-white pt-6 font-bold text-lg md:text-xl leading-5 md:leading-7" >
                        ...
                        <div id="rect" className="md:text-2xl md:leading-7 w-4/5 md:mt-28 mt-32 mx-auto font-bold flex shadow-2xl bg-white h-24 md:h-48 rounded-md divide-x py-10">
        ...
        <section id="bg3" className="md:mx-0 mx-10 flex flex-col md:flex-row md:justify-around py-30 pb-16 md:pb-48">
                    ...
                    <div className="pt-16 md:pt-60 ">
                        <span className="text-xl md:text-4xl font-semibold ">We Provide Good Coffee <br /> and Healthy Meals </span> <br /> <br />
        ...
        <section className="bg-gray-50">
                    ...
                    <div className="text-black text-center md:mx-0 mx-10 text-2xl md:text-4xl font-medium leading-12 pt-20">Here is People’s Favorite <br />
                    ...
                    <div className="border-4 md:w-80 w-64 box5 rounded-lg pt-12 md:pt-16 bg-white hover:border-yellow-700">
                        ...
                        <div className="text-center pt-8 md:pt-20 text-lg font-medium">Hazelnut Latte</div>
                            ...
                            <div className="text-2xl font-medium text-center pt-8 md:pt-32">IDR 25.000</div>
                            <div className="flex">
                    ...
                    <div className="border-4 md:w-80 w-64 box5 rounded-lg pt-12 md:pt-16 bg-white hover:border-yellow-700">
                        ...
                        <div className="text-center pt-8 md:pt-20 text-lg font-medium">Pinky Promise</div>
                        ...
                        <div className="text-2xl font-medium text-center pt-8 md:pt-24">IDR 25.000</div>
                        <div className="flex">
                        <button className=" mt-5 mx-auto text-base font-bold bg-white hover:bg-yellow-400 text-yellow-700 font-semibold py-3 px-12 border border-yellow-400 rounded-full">
                            Order Now
                        </button>
                    ...
                    <div className="border-4 md:w-80 w-64 box5 rounded-lg pt-12 md:pt-16 bg-white hover:border-yellow-700">
                        ...
                        <div className="text-center pt-8 md:pt-20 text-lg font-medium">Chicken Wings </div>
                    ...
                    <div className="text-center text-xl md:text-4xl font-medium pb-3 ">Visit Our Store in the </div>
                    <div className="text-center text-xl md:text-4xl font-medium">Spot on the Map Below</div>
        ...
        <section>     
                    ...
                    <div className="text-center text-2xl md:text-4xl font-medium pb-20">Our Partner</div>
        ...
        <section className="slider pl-10 md:pl-40 pb-20 ">
                    ...
                    <section className="flex flex-row  justify-between mx-10 md:mx-40">
                        ...
                        <div id="rect2" className="flex flex-col md:flex-row  font-bold text-xl md:text-4xl md:justify-between items-center shadow-2xl bg-white h-48 rounded-md md:px-20 ">
                            <div className="md:leading-7 leading-6"> Check our promo <br /> today! <br /> 
